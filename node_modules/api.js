...
function getDomain(nhsNo, domain) {
  ...
  /*
   ...
   domain = {
     name: 'allergies',
     callback: //callback function when data is ready - no arguments,
     query: {
       aql: [part 1, patientId, part 2],
       sql: [part 1, patientId, part 2]
     }
     hosts: {
       ethercis: {
         queryType: 'sql',
    ...
    */
    ...
    if (body && body.resultSet) {
      body.resultSet.forEach(function(allergy) {
        if (allergy.cause !== '' && allergy.cause !== null) {
          var record = {
    ...
    var allergiesGlo = new q.documentStore.DocumentNode('ripplePatientSummary', [process.pid, 'allergies']);
    allergiesGlo.setDocument(allergies);
