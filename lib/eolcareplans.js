module.exports = {
  ...
  fieldMap: {
    ...
    cprDecision: function(record) {
      return {
        cprDecision: record.cpr_decision,
        dateOfDecision: record.cpr_date_of_decision,
    ...
    treatmentDecision: function(record) {
      return {
        decisionToRefuseTreatment: record.treatment_decision,
        dateOfDecision: record.treatment_date_of_decision,
